...
<form action="<?php echo base_url();?>/AmendOrder/<?= $order['orderNumber'] ?>" method="post" enctype="multipart/form-data"> 
	...
	<input type="date" name="requiredDate" id="requiredDate" value="<?php echo $order['requiredDate']?>"> 
...
<select name="status" id="status">
    <option readonly value="shipped" <?php echo ($order['status'] == 'shipped') ? 'selected' : ''; ?>>Shipped</option>
    <option readonly value="In Process" <?php echo ($order['status'] == 'inProcess') ? 'selected' : ''; ?>>In Process</option>
    <option readonly value="On Hold" <?php echo ($order['status'] == 'onHold') ? 'selected' : ''; ?>>On Hold</option>
    <option value="Disputed" <?php echo ($order['status'] == 'disputed') ? 'selected' : ''; ?>>Disputed</option>
	<option readonly value="Cancelled" <?php echo ($order['status'] == 'cancelled') ? 'selected' : ''; ?>>Cancelled</option>
