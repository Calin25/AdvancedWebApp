...
<header class="headerNav center-navbar">
    <nav class="navbar navbar-expand-lg custom-navbar">
        ...
        <a href="<?php echo base_url(); ?>/MemberHomeView"><img src="<?= base_url('assets/images/site/logo1.png') ?>" alt="Logo"></a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="<?php echo base_url(); ?>/MemberHomeView">Home</a>
                <li class="nav-item">
